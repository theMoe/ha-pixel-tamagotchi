...
<svg viewBox="-4 -4 24 22" xmlns="http://www.w3.org/2000/svg">
  <g class="rig">
    ...
    <g class="layer hat-sun_hat"><rect x="3" y="3" width="10" height="1" fill="#f6d365"/><rect x="5" y="1" width="6" height="2" fill="#f2c14e"/><rect x="6" y="0" width="4" height="1" fill="#f2c14e"/><rect x="5" y="2" width="6" height="1" fill="#e53935"/></g>
    ...
    <g class="layer item-cocktail"><rect x="13" y="7" width="3" height="1" fill="#fff" opacity=".6"/><rect x="13" y="8" width="3" height="2" fill="#ff7043"/><rect x="14" y="10" width="1" height="1" fill="#eceff1"/><rect x="13" y="11" width="3" height="1" fill="#eceff1"/><rect x="14" y="5" width="2" height="1" fill="#e91e63"/><rect x="15" y="6" width="1" height="1" fill="#8d6e63"/></g>
